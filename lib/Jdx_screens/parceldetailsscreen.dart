...
class _ParceldetailsScreenState extends State<ParceldetailsScreen> {
      ...
      body: SingleChildScrollView(
        child: parceldetails?.data?.isEmpty ?? true
          ...
          children: [
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                        ...
                                        onTap: () {
                                          ...
                                          String lon =
                                              item.senderLongitude.toString() ??
                                                  ''; //'75.8545'; //
                                          String CURENT_LAT =
                                              item.driverDetails?.latitude
                                                  .toString() ?? '';
                                          String CURENT_LONG =
                                              item.driverDetails?.longitude
                                                  .toString() ?? '';
                                  ...
                                  widget.isFromParcelHistory ? Align(
                                    alignment: Alignment.topLeft,
                                    child: const Text("Driver Detail:",
                                        style: TextStyle(
                                            color: Colors.red)),
                                  ) : SizedBox(),
                                  widget.isFromParcelHistory ?  drivercard(
                                      image: item.driverDetails?.userImage,
                                      name: item.driverDetails?.userFullname,
                                      phone: item.driverDetails?.userPhone,
                                      email: item.driverDetails?.userEmail,
                                      vehicleNo: item.driverDetails?.vehicleNo) : SizedBox()
            ...
            widget.isFromParcelHistory ? const SizedBox.shrink() : SizedBox(
              height: 50,
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  print('__________${couponCode?.data?[index]
                      .couponCode}_______hiii______');
                  ...
                  return Card(
                    child: Padding(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text(couponCode?.data?[index].couponCode ?? '', style: TextStyle(fontWeight: FontWeight.bold),),
                            InkWell(
                                onTap: () {
                                  if (double.parse(
                                      couponCode?.data?[index].cartValue ??
                                          '0') <= totalPrice) {
            ...
            widget.isFromParcelHistory ? const SizedBox.shrink() : Container(
  ...
  Widget drivercard(
      {String? image, String? name, String? email, String? phone, String? vehicleNo }) {
    return Card(
      color: splashcolor,
      elevation: 4,
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            CircleAvatar(
              ...
              backgroundImage: NetworkImage('https://developmentalphawizz.com/JDX/${image}'  ),
              radius: 40,
            ),
            SizedBox(width: 16),
            Expanded(
  ...
  void getCoupon() async {
    ...
    var request = http.Request(
        'GET', Uri.parse('${ApiPath.baseUrl}Products/couponList'));
  ...
  String calculateDistance(late1, lone1, late2, lone2) {
    ...
    if (late1 != null && late2 != null && lone1 != null && lone2 != null &&
        late1 != "" && late2 != "" && lone1 != "" && lone2 != "") {
